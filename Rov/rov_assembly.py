...
class rovAssembly(agxSDK.Assembly):
    def __init__(self, keyboard):
        ...
        self.link2.setPosition(0.05, 0.22, 0)
        link2rot=agx.Vec3(0.1, 0.22, 0)
        self.link2.setRotation(agx.EulerAngles(0, math.pi, math.pi))
        self.link2.setName("wing_r")
        self.link3 = create_wing_left(aluminum1)
        self.link3.setPosition(0.05, -0.22, 0)
        link3rot = agx.Vec3(0.1, -0.22, 0)
        ...
        #  agx.Vec3(self.link2.getPosition()
        print("mass", self.link1.getMassProperties().getMass())
        ...
        self.hinge1.getRange1D().setRange(math.radians(15), math.radians(25))
        ...
        self.hinge2.getRange1D().setRange(math.radians(15), math.radians(25))
       ...
       # self.add(self.distance3)
        print("bodies", [g.getName() for g in self.getRigidBodies()])
        self.setName('rov')
