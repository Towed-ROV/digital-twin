...
WheelLoaderD300:
    ...
    Examples:
        ...
        from agxPythonModules.models.wheel_loaders import WheelLoaderDL300

        wheel_loader_keyboard = WheelLoaderDL300( keyboard_controls = WheelLoaderDL300.default_keyboard_controls() )
        simulation().add( wheel_loader_keyboard )

        wheel_loader_gamepad = WheelLoaderDL300( gamepad_controls = WheelLoaderDL300.default_gamepad_controls() )
        wheel_loader_gamepad.setPosition( 0, -4, 0 )
        simulation().add( wheel_loader_gamepad )

        my_tire_settings      = WheelLoaderDL300.default_tire_settings()
        my_driveline_settings = WheelLoaderDL300.default_driveline_settings()
        my_keyboard_controls  = WheelLoaderDL300.default_keyboard_controls()
        ...
        # Create our custom wheel loader DL300.
        my_wheel_loader = WheelLoaderDL300( tire_settings      = my_tire_settings,
...
class WheelLoaderDL300(WheelLoader):
    """
    ...
    Examples:
        ...
        tire_settings = WheelLoaderDL300.default_tire_settings()
        tire_settings.stiffness.radial = 1.0E6

        keyboard_settings = WheelLoaderDL300.default_keyboard_settings()
        ...
        wheel_loader1 = WheelLoaderDL300( tire_settings     = tire_settings,
                                          keyboard_settings = keyboard_settings )
        wheel_loader1.setPosition( 0, 5, 0 )
        simulation().add( wheel_loader1 )

        wheel_loader2 = WheelLoaderDL300()
        simulation().add( wheel_loader2 )
    """

    model_path         = 'data/models/wheel_loader_DL300.agx'
    model_top_edge     = agx.Line( agx.Vec3( -1.48,  0.45,  0.232 ),
                                   agx.Vec3(  1.43,  0.476,  0.264 ) )
    model_cutting_edge = agx.Line( agx.Vec3( -1.45, -0.788,  0.532 ),
                                   agx.Vec3(  1.436, -0.762,  0.565 ) )
    model_cutting_dir  = agx.Vec3( 0, -0.15, 1 ).normal()
    ...
    def __init__(self, **kwargs):
        ...
        Arguments:
            driveline_settings: Struct - driveline settings, WheelLoaderDL300.default_driveline_settings() is used if not given.
            tire_settings: Struct - tire settings, WheelLoaderDL300.default_tire_settings() is used if not given.
            keyboard_controls: Struct - keyboard controls (e.g., WheelLoaderDL300.default_keyboard_controls())
            gamepad_controls: Struct - gamepad controls (e.g., WheelLoaderDL300.default_gamepad_controls())
        """
